            ...
            <div class="container-fluid current-head">
                <div class="row align-items-center mb-3">
                    ...
                    <div class="col-lg-8 text-end">
                        ...
                        <a href="<?php echo e(route('personalis_bsm_2.show')); ?>" class="btn g-button me-2">Show</a>
                        <a href="<?php echo e(route('personalis_bsm_2.delete-all')); ?>" class="btn btn-danger">Delete All</a>
                    </div>
                </div>
            </div>
