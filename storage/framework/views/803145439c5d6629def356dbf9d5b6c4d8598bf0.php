        ...
        <div class="tab-pane active" id="currentweek" role="tabpanel" aria-labelledby="currentweek-tab">
            <div class="container-fluid current-head">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <button type="button" href="<?php echo e(route('retry')); ?>" class="btn btn-danger retry-btn">Retry
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u749698746/domains/koderspedia.net/public_html/tissue-dashboard/resources/views/error-files/index.blade.php ENDPATH**/ ?>