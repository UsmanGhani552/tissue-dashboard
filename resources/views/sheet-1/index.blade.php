                                ...
                                <td>
                                    <div class="dropdown open">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="triggerId">
                                            <a class="dropdown-item" href="{{ route('sheet1-show', $sheet1->id) }}">Show</a>
                                            <a class="dropdown-item" href="{{ route('sheet1-delete', $sheet1->id) }}">Delete</a>
                                        </div>
                                    </div>
