      ...
      <div class="tab-pane active" id="currentweek" role="tabpanel" aria-labelledby="currentweek-tab">
          <div class="container-fluid current-head">
              <div class="row">
                  ...
                  <div class="col-lg-6">
                      <form class="d-flex gap-2" action="<?php echo e(route('import-manifest')); ?>" method="POST" enctype="multipart/form-data">
                          <?php echo csrf_field(); ?>
                          <div>
                  ...
                  <div class="bottomTable">
                      <table class="table dataTable">
                          ...
                          <tbody class="overflow-auto">
                              ...
                              <tr>
                                  <td><?php echo e($manifest->id); ?></td>
                                <td><?php echo e($manifest->name); ?></td>
                                  ...
                                  <td>
                                      <div class="dropdown open">
                                          ...
                                          <a class="dropdown-item" href="<?php echo e(route('manifest-show', $manifest->id)); ?>">Show</a>
                                              <a class="dropdown-item" href="<?php echo e(route('manifest-delete', $manifest->id)); ?>">Delete</a>
                                          </div>
                                      </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Downloads\laragon\www\tissue-dashboard\resources\views/manifest/index.blade.php ENDPATH**/ ?>