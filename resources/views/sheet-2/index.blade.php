      ...
      <div class="tab-pane active" id="currentweek" role="tabpanel" aria-labelledby="currentweek-tab">
          <div class="container-fluid current-head">
              <div class="row">
                  ...
                  <div class="col-lg-6">
                      <form class="d-flex gap-2" action="{{ route('import-sheet2') }}" method="POST" enctype="multipart/form-data">
                          @csrf
                          <div>
                                  ...
                                  <td>
                                      <div class="dropdown open">
                                          ...
                                          <div class="dropdown-menu" aria-labelledby="triggerId">
                                              <a class="dropdown-item" href="{{ route('sheet2-show', $sheet2->id) }}">Show</a>
                                              <a class="dropdown-item" href="{{ route('sheet2-delete', $sheet2->id) }}">Delete</a>
                                          </div>
                                      </div>
