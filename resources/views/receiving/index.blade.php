    ...
    <div class="tab-pane active" id="currentweek" role="tabpanel" aria-labelledby="currentweek-tab">
        <div class="container-fluid current-head">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <form class="d-flex gap-2" action="{{ route('import-receiving') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div>
                                ...
                                <td>
                                    <div class="dropdown open">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="triggerId">
                                            <a class="dropdown-item" href="{{ route('receiving-show', $receiving->id) }}">Show</a>
                                            <a class="dropdown-item" href="{{ route('receiving-delete', $receiving->id) }}">Delete</a>
                                        </div>
                                    </div>
